                            ...
                            filteredGoods.map((goodsData) => (
                                <div className="col-md-4 mb-3" key={goodsData.id}>
                                    <div className="card text-center" style={{ height: '280px' }}>
                                        {goodsData.image && (
                                            <Link to={`/goodsData/${goodsData.id}`} style={{ display: 'inline-block', height: '250px', overflow: 'hidden' }}>
                                                <img
                                                    src={goodsData.image}
                                                    alt="Good"
                                        ...
                                        <div className="card-body">
                                            <h5 className="card-title">
                                                <Link to={`/goodsData/${goodsData.id}`} style={{ textDecoration: 'none' }}>{goodsData.name}</Link>
                                            </h5>
